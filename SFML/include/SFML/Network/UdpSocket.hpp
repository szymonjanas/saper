...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    Status bind(int port, const IpAddress& address = IpAddress::Any);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Status send(const void* data, std::size_t size, const IpAddress& remoteAddress, int remotePort);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Status receive(void* data, std::size_t size, std::size_t& received, IpAddress& remoteAddress, int& remotePort);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Status send(Packet& packet, const IpAddress& remoteAddress, int remotePort);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Status receive(Packet& packet, IpAddress& remoteAddress, int& remotePort);
